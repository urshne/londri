    ...
    <form id="formKaryawan">
        <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2.5">
                         <input type="number" class="form-control" name="anak" id="anak" placeholder="Pilih" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-1">
                          <input class="form-check-input" type="radio" value="Single" name="sm" ID="sm">
                          <label class="form-check-label">Single</label>
                        </div>
                        <div class="col-sm-1">
                            <input class="form-check-input" type="radio" value="Couple" name="sm" ID="sm">
                            <label class="form-check-label">Couple</label>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <table class="table table-compact table-striped table-bordered" id="tblKaryawan">
            ...
            <tfoot>
                <tr>
                    ...
                    <td><span id="tunjangan"></span></td>
                    <td><span id="totalg"></span></td>
